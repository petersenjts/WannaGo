...
export default function StayRequestPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16 [--accent:var(--color-stay)] sm:px-10">
      <Link href="/" className="text-sm text-muted hover:text-ink-soft">
        ← Back
      </Link>
      <p className="mt-6 text-sm font-medium uppercase tracking-wide text-stay-strong">Wannago</p>
